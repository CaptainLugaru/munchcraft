...
public class CodeCrystalOreBlock extends MunchcraftModElements.ModElement {
	@ObjectHolder("munchcraft:code_crystal_ore")
	public static final Block block = null;
	public CodeCrystalOreBlock(MunchcraftModElements instance) {
		super(instance, 3);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("code_crystal_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("munchcraft:code_crystal_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("code_crystal_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("munchcraft:code_crystal_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
